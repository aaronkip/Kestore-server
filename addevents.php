<?php include("controller/addevents.php");?>
                ...
                <div class="card-body">
				  ...
				  <div class="form-group">
					...
					<div class="form-group">
                     ...
                     <input type="text" name="etags" id="etags" class="form-control" required>
                    </div>
					
					<div class="form-group">
                
                  <label>Location</label>
                  <input type="text" class="form-control" name="eaddress" id="us3-address" required />
              ...
              <div class="form-group">
				...
				<div class="form-group row">
                      <div class="col">
                        ...
                        <input type="text" name="elatitude" id="us3-lat" class="form-control" required>
                      </div>
                      <div class="col">
                        <label>Longitude</label>
                        <input type="text" name="elongitude" id="us3-lon" class="form-control" required>
                      </div>
                    </div>
					
			  <div class="form-group">
                      <label for="exampleInputName1">Description</label>
                      <textarea name="edescription" id="edescription" class="form-control" required></textarea>
					  </div>
				  ...
				  <div class="form-group">
                      ...
                      <div class="input-group col-xs-12">
                        <input type="file" name="eimage" id="fileupload" required>
                      </div>
                    </div>
