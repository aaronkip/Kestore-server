...
<div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                ...
                <tr>
				   ...
				   <td><img class="card-img-top" src="images/city/<?php echo $users_row['cityimage'];?>" onerror="this.onerror=null;this.src='<?php echo BASE_URL; ?>asset/images/users.png';" alt="Card image cap"></td>
