<?php include("controller/editcity.php");?>
                ...
                <div class="card-body">
				  ...
				  <input  type="hidden" name="cityid" value="<?php echo $_GET['cityid'];?>" />
					...
					<div class="form-group">
                     ...
                     <input type="text" name="cityname" id="cityname" value="<?php echo $row['cityname'];?>" class="form-control">
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="input-group col-xs-12">
                        <input type="file" name="cityimage" id="fileupload">
                      </div>
                    </div>
					<div class="form-group">
                    <label class="col-xs-12 control-label">&nbsp; </label>
                    <div class="col-md-12">
                        <?php if($row['cityimage']) {?>
                              <div class="cityimage"><img src="images/city/<?php echo $row['cityimage'];?>" width="100%" /></div>
                        <?php }else{ ?>
                        	<div class="cityimage"> <img type="image" src="assets/images/add-image.png" width="100%" alt="category image" /> </div>
                        <?php }?>
                    </div>
                  </div>
