<?php include("controller/addcity.php");?>
                ...
                <div class="card-body">
				  ...
				  <input  type="hidden" name="cityid"/>
					...
					<div class="form-group">
                     ...
                     <input type="text" name="cityname" id="cityname" value="" class="form-control" required>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="input-group col-xs-12">
                        <input type="file" name="cityimage" id="fileupload" required>
                      </div>
                    </div>
